<template>
  <KnowledgeModuleShell v-if="detail" :crumbs="crumbs" narrow>
  ...
  <KnowledgeModuleShell v-else-if="!loading && errMsg" :crumbs="crumbsError" narrow>
...
import { getNotificationDetail, markNotificationRead } from '@/api/user'
...
const crumbs = computed(() => {
  ...
  return [...base, { label: short, titleAttr: t }]
})
